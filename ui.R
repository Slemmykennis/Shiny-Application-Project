...
shinyUI(fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
            helpText("Predict the price of a diamond using this characteristics: carats, color and clarity."),
            h3(helpText("Select:")),
            ...
            submitButton("Check the price")
        ),
        
        # Show a plot with diamonds and regression line
        mainPanel(
            plotOutput("plot1"),
            h4("The predicted price of this diamond based on the carat, color and clarity is:"),
